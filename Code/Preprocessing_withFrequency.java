...
public class Preprocessing_withfreq extends Configured implements Tool {

	private static final Logger LOG = Logger
			.getLogger(Preprocessing_withfreq.class);
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Preprocessing_withfreq(), args);
		System.exit(res);
	}
